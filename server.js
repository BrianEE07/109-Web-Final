...
import homeRouter from './server/routes/chickens.js'; 
import usersRouter from './server/routes/users.js';
import mongoose from 'mongoose' 
import dotenv from 'dotenv-defaults'
import http from 'http';
import WebSocket from 'ws';
import GG from './server/game.js';
// 之後拿掉
import { saveNewUser, clearDB, printDB } from './server/core/userDB.js'
import { saveNewChicken, printChDB, updateHunger, clearChDB, updateHealth, updateHappiness, getUser , updateLifeTime, updateStage, } from './server/core/chickenDB.js'
// 之後拿掉
const app = express();
